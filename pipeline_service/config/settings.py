...
class Settings(BaseSettings):
    ...
    candidate_ranges: list[tuple[int, int]] = Field(default=[
        (25000, 3),    # 0-15k voxels → 4 candidates
        (35000, 2),    # 15k-25k voxels → 3 candidates
        (50000, 1),    # 25k-50k voxels → 2 candidates
    ...
    timeout_ranges: list[tuple[int, int]] = Field(default=[
        (25000, 27),   # 0-25k voxels → 28 seconds timeout
        (35000, 26),   # 0-25k voxels → 28 seconds timeout
